...
class TruckDataWindow(QDialog):
    ...
    def setupButtons(self):
        ...
        self.loadButton = QPushButton("Load good table")
        self.loadButton.clicked.connect(self.load_good_from_file)
    ...
    def setupLayout(self):
        ...
        self.buttonvLayout.addWidget(self.doneButton)
        self.buttonvLayout.addWidget(self.loadButton)
        self.hBoxMainData.addLayout(self.buttonvLayout)
